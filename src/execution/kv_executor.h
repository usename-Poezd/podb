...
public:
  ...
  Task Execute(Task request) {
    ...
    case TaskType::SET_REQUEST: {
      ...
      PODB_VLOG("[Core %d] EXEC SET \"%.20s\" size=%zu → OK   reply→Core %d\n",
    ...
    case TaskType::GET_REQUEST: {
      ...
      PODB_VLOG("[Core %d] EXEC GET \"%.20s\"        → %-5s reply→Core %d\n",
    ...
    case TaskType::TX_EXECUTE_GET_REQUEST: {
      ...
      PODB_VLOG("[Core %d] EXEC TX_GET \"%.20s\" tx=%lu snap=%lu → %-5s reply→Core %d\n",
    ...
    case TaskType::TX_EXECUTE_SET_REQUEST: {
      ...
      PODB_VLOG("[Core %d] EXEC TX_SET \"%.20s\" tx=%lu → %s reply→Core %d\n",
    ...
    case TaskType::TX_FINALIZE_COMMIT_REQUEST: {
      ...
      PODB_VLOG("[Core %d] EXEC FIN_COMMIT tx=%lu commit_ts=%lu\n",
    ...
    case TaskType::TX_PREPARE_REQUEST: {
      ...
      PODB_VLOG("[Core %d] EXEC PREPARE tx=%lu → %s\n",
    ...
    case TaskType::TX_FINALIZE_ABORT_REQUEST: {
      ...
      PODB_VLOG("[Core %d] EXEC FIN_ABORT tx=%lu\n", core_id_, request.tx_id);
    ...
    case TaskType::GC_REQUEST: {
      ...
      PODB_VLOG("[Core %d] GC watermark=%lu removed=%zu\n",
